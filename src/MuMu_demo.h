...
// propagator to the muon system
#include "L1DiMuonMatcherAlgo.h"
...
class MuMu_demo : public edm::one::EDAnalyzer<> {  
public:
  explicit MuMu_demo(const edm::ParameterSet&);
  ~MuMu_demo() override = default;
  // setup
...
private:
  ...
  edm::EDGetTokenT<pat::TriggerObjectStandAloneCollection> propL1Token_;
  // offline - L1 matching
